...
NOTE: This sample is only supported by 3ds Max 2016 to 3ds Max 2021 when MaxPlus was available.  
It is not supported in 3ds Max 2022 and later, as the MaxPlus API was removed.  
'''
